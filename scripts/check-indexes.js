...
const expectedIndexes = {
  ...
  messages: [
    ...
    { name: 'idx_messages_conversation_role_created', columns: ['conversation_id', 'role', 'created_at'], desc: true },
  ],
  gems: [
  ...
  attachments: [
    ...
    { name: 'idx_attachments_conversation_user_created', columns: ['conversation_id', 'user_id', 'created_at'], desc: true },
  ],
};
