...
const ALLOWED_EXTS = new Set(["txt", "js", "jsx", "png", "jpg", "jpeg", "webp"]);
...
export async function validateUpload({ file, filename }) {
  ...
  const isTextExt = ["txt", "js", "jsx"].includes(ext);
  ...
  if (isTextExt) {
    ...
    return { kind: "text", filename: safeName, ext, mime: mime || "text/plain", sizeBytes: size };
  }
