export const vi = {
  ...
  globalPersonasManagement: "Quản lý Personas hệ thống",
  addPersona: "Thêm Persona",
  noGlobalPersonas: "Chưa có persona hệ thống nào",
  editGlobalPersona: "Sửa Persona hệ thống",
  createGlobalPersona: "Tạo Persona hệ thống",
  confirmDeletePersona: "Bạn có chắc chắn muốn xóa persona này?",
  deletePersonaWarning: "Hành động này không thể hoàn tác.",
  loadingPersonas: "Đang tải personas...",
  personaCount: "personas",
  failedDeletePersona: "Không thể xóa persona",
  failedSavePersona: "Không thể lưu persona",
  premadePersonas: "Personas có sẵn",
  // Rank Config Manager
  ...
  // Personas
  managePersonas: "Quản lý Personas",
  personasTitle: "Quản lý Personas",
  personaCreate: "Tạo Persona",
  personaEdit: "Sửa Persona",
  personaDelete: "Xóa Persona",
  personaSave: "Lưu Persona",
  personaName: "Tên Persona",
  personaDescription: "Mô tả",
  personaTone: "Phong cách & Giọng điệu",
  personaCharacteristics: "Đặc điểm",
  personaUseEmojis: "Sử dụng Emoji",
  personaUseHeadersLists: "Tiêu đề & Danh sách",
  personaUserContext: "AI nên biết gì về bạn?",
  personaCustomInstructions: "Hướng dẫn tùy chỉnh (Quy tắc)",
  personaPlaceholderName: "VD: Trợ lý Lập trình, Tư vấn Pháp luật",
  personaPlaceholderDesc: "Mô tả ngắn gọn về persona",
  personaPlaceholderContext: "VD: Tôi là kỹ sư phần mềm, làm việc với ứng dụng web...",
  personaPlaceholderInstructions:
    "VD: Luôn bắt đầu bằng tóm tắt TL;DR, dùng bullet points cho đoạn văn dài...",
  personaDeleteConfirm: "Xóa Persona?",
  personaDeleteWarning: "Bạn có chắc chắn muốn xóa persona này? Hành động này không thể hoàn tác.",
  personaDeleted: "Đã xóa persona thành công",
  personaCreated: "Đã tạo persona!",
  personaSaved: "Đã lưu persona!",
  ...
  deepResearchDesc: "AI nghiên cứu chuyên sâu với nhiều nguồn",
  deepResearchStart: "Bắt đầu nghiên cứu",
  ...
  deepResearchEditPlan: "Chỉnh sửa kế hoạch",
  deepResearchApprovePlan: "Bắt đầu nghiên cứu",
  deepResearchReport: "Báo cáo nghiên cứu",
  deepResearchOpen: "Mở",
  ...
  deepResearchSources: "Nguồn tham khảo",
  deepResearchGeneratingThoughts: "Đang tạo quá trình suy luận...",
  deepResearchEditPlanPrompt: "Bạn muốn thay đổi hoặc bổ sung gì vào kế hoạch này?",
  deepResearchCreateConversation: "Tạo hội thoại",
  deepResearchExportMarkdown: "Xuất Markdown",
  deepResearchExportPdf: "Xuất PDF",
  deepResearchCopyReport: "Sao chép báo cáo",
  deepResearchCopied: "Đã sao chép!",
  deepResearchTocTitle: "Mục lục",
  deepResearchElapsed: "Thời gian đã trôi qua",
