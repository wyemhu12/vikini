export const en = {
  ...
  gemDeleteWarning: "Are you sure you want to delete this Gem? This action cannot be undone.",
  gemDeleted: "Gem deleted successfully",
  gemSaved: "Gem saved successfully!",
  ...
  deepResearchGeneratingThoughts: "Generating thought process...",
  deepResearchEditPlanPrompt: "What would you like to change or add to this plan?",
  deepResearchCreateConversation: "Create conversation",
  deepResearchExportMarkdown: "Export Markdown",
  deepResearchExportPdf: "Export PDF",
  deepResearchCopyReport: "Copy report",
  deepResearchCopied: "Copied!",
  deepResearchTocTitle: "Table of Contents",
  deepResearchElapsed: "Elapsed time",
