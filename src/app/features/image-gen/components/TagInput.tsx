      ...
      <div className={cn("flex flex-wrap items-center gap-1", className)}>
        ...
        {tags.length < MAX_TAGS && (
          <button
            ...
            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[9px] font-medium bg-white/5 text-white/50 hover:text-white/80 hover:bg-white/10 border border-white/10 transition-colors"
            title={t("studioAddTag")}
          >
