...
export default function ControlPanel({
  ...
  return (
    <aside className="w-full md:w-80 border-r border-[var(--border)] h-full flex flex-col bg-[var(--surface-base)] relative z-20 shadow-xl overflow-hidden pt-4 overflow-y-auto">
      ...
      <div className="space-y-2 px-6">
        ...
        <Textarea
          ...
          className="h-32 resize-none bg-[var(--input-bg)] border-[var(--input-border)] focus-visible:ring-1"
          value={prompt}
          ...
          className={`
                        ...
                        ${
                          isEnhancerOn
                            ...
                            : "bg-[var(--input-bg)] border border-[var(--input-border)] hover:border-purple-500/20"
                        }
                    `}
        >
          <div
      ...
      <div className="space-y-2 px-6 mt-4">
        ...
        <Select value={model} onValueChange={setModel}>
          <SelectTrigger className="w-full bg-[var(--surface-elevated)] border-[var(--border)]">
            <SelectValue placeholder={t("studioSelectModel")} />
          </SelectTrigger>
          <SelectContent className="bg-[var(--surface-elevated)] border border-[var(--border)] shadow-xl z-[100]">
            ...
            <button
              ...
              className={cn(
                ...
                aspectRatio === ratio
                  ...
                  : "bg-[var(--surface-elevated)] border-[var(--border)] hover:bg-[var(--surface-hover)]"
              )}
            >
              {ratio}
            </button>
