...
import { CodeXml, BarChart3, Image as ImageIcon, Clock } from "lucide-react";

const Skeleton = () => (
  <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-[var(--control-bg)] to-[var(--surface-muted)] animate-pulse" />
);
  ...
  const items = [
    {
      ...
      header: <CodeXml className="w-10 h-10 text-[var(--accent)]" />,
    ...
    },
    {
      ...
      header: <BarChart3 className="w-10 h-10 text-blue-400" />,
      className: "col-span-1",
    ...
    },
    {
      ...
      header: <ImageIcon className="w-10 h-10 text-pink-400" />,
      className: "col-span-1",
    ...
    },
    {
      ...
      header: <Clock className="w-10 h-10 text-gray-400" />,
      className: "col-span-1",
      prompt: null,
    },
  ];
