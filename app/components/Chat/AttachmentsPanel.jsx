...
function isTextMime(mime) {
  const m = String(mime || "");
  return m.startsWith("text/") || m.includes("javascript");
}

export default function AttachmentsPanel({ conversationId, disabled, onAfterAnalyze }) {
  ...
  const doAnalyze = useCallback(
    async (a) => {
      ...
      try {
        ...
        if (typeof onAfterAnalyze === "function") {
          await onAfterAnalyze();
        }
      } catch (e) {
        console.error(e);
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              type="file"
              multiple
              accept=".txt,.js,.jsx,.png,.jpg,.jpeg,.webp"
              className="hidden"
        ...
        <div className="mt-3 space-y-2">
            ...
            >
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={() => doAnalyze(a)}
                  className="rounded-md bg-[var(--primary)] px-2 py-1 text-xs font-medium text-black"
                >
                  Analyze
                </button>
                <button
          ...
          {attachments.length === 0 ? (
            <div className="text-xs text-neutral-500">Drop files here or click Upload.</div>
          ) : null}
        </div>
      </div>
