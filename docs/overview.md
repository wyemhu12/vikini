...
- **AI Image Generation**: Công cụ tạo ảnh chuyên nghiệp hỗ trợ nhiều model như Gemini Imagen 3, DALL-E 3, Flux Pro. Có sẵn các phong cách (style presets), tùy chỉnh tỷ lệ ảnh và tính năng AI cải thiện câu lệnh (prompt enhancement).
